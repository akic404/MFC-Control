...
#include "DAC8563.h"
//-----------------------------------------------------------------
u16 sin_data[256]={0x7FFF,0x8323,0x8647,0x896A,0x8C8B,0x8FAA,0x92C7,0x95E1,0x98F8,0x9C0A,0x9F19,0xA223,0xA527,0xA826,0xAB1E,0xAE10
...
int main(void)
{
  ...
  HAL_Init();          		// 初始化HAL库
	...
	{	
		for(i=0;i<256;i++)
		{
			DAC8563_Write_CHA_CHB(sin_data[i]);
		}
	}
}
