...
#define DAC8563_SCLK_L     	HAL_GPIO_WritePin(GPIOF,GPIO_PIN_7,GPIO_PIN_RESET)
#define DAC8563_SCLK_H     	HAL_GPIO_WritePin(GPIOF,GPIO_PIN_7,GPIO_PIN_SET)
#define DAC8563_DIN_L      	HAL_GPIO_WritePin(GPIOF,GPIO_PIN_9,GPIO_PIN_RESET)
#define DAC8563_DIN_H     	HAL_GPIO_WritePin(GPIOF,GPIO_PIN_9,GPIO_PIN_SET)
